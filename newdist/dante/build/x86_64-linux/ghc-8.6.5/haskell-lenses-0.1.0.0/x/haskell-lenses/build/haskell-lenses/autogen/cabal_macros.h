...
/* package haskell-lenses-0.1.0.0 */
#ifndef VERSION_haskell_lenses
#define VERSION_haskell_lenses "0.1.0.0"
#endif /* VERSION_haskell_lenses */
#ifndef MIN_VERSION_haskell_lenses
#define MIN_VERSION_haskell_lenses(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_haskell_lenses */
...
#define CURRENT_COMPONENT_ID "haskell-lenses-0.1.0.0-inplace-haskell-lenses"
